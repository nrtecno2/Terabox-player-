...
| `CHANNEL_USERNAME` | Channel username without @ | `nrtecno2` |
| `CHANNEL_ID` | Channel ID (must be admin) | `-1001234567890` |
| `PRIVATE_CHANNEL_ID` | Private channel for uploads | `-1009876543210` |
| `WEBHOOK_URL` | Your Render app URL | `https://your-app.onrender.com` |
